...
urlpatterns = [
    ...
    path("add_working_hours/", views.create_working_hours, name="add_working_hours"),
    path("update_working_hours/<int:id>/", views.update_working_hours, name="update_working_hours"),
]
