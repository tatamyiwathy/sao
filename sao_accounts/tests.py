...
class AccountTest(TestCase):
    ...
    def test_post_with_nouser(self):
        ...
        response = client.get(
            reverse("sao_accounts:edit", kwargs={"username": "nanashi"})
        )
...
class AccountViewsTests(TestCase):
    ...
    def test_account_list_only_active_for_normal_user(self):
        inactive_user = create_user_util(
            username="inactive", last="", first="", password="pass", email=""
        )
    ...
    def test_change_password_form_valid(self):
        form = SaoChangePasswordForm(
            data={"password": "newsecurepassword", "confirm": ""}
        )
